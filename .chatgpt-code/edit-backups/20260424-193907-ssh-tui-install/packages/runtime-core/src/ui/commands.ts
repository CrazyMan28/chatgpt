...
export type AppCommand =
  ...
  | { host: string; name: string; port?: number; type: "ssh_add"; username?: string }
  | { type: "mcp_add" }
  | { type: "mcp_list" }
...
const COMMAND_REFERENCE: ReadonlyArray<{
  ...
  {
    command: "/ssh",
    usage: "/ssh add <name> <host> [username] [port] | list | test <name> | remove <name>",
    description: "Manage SSH worker shortcuts."
  },
  {
