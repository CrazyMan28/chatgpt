...
export declare function runTui({ approvalManager, executionContextController, fleetManager, goalStore, initialSession, memoryStore, mcpManager, modelRuntime, projectRecord, projectRegistryStore, remoteManager, sessionRegistryStore, sessionStore, taskRunner, toolRegistry, timelineStore, watcherStore, workspaceRoot }: RunTuiOptions): Promise<void>;
//# sourceMappingURL=run-tui.d.ts.map