...
export type ApprovalPolicyPreset = "ask-every-time" | "approve-once" | "approve-task" | "approve-session" | "approve-all" | "auto-safe" | "auto-safe-medium" | "full" | "strict";
export type ApprovalGrantScope = "once" | "task" | "session" | "all";
export type FilesystemScope = "workspace" | "home" | "full-machine" | "remote-host";
...
export interface GoalRecord {
    ...
    state: "queued" | "planning" | "asking" | "waiting_approval" | "running" | "validating" | "paused" | "rate_limited" | "complete" | "failed" | "cancelled";
}
export interface FleetAgentRecord {
    ...
    state: "queued" | "running" | "waiting" | "paused" | "complete" | "failed" | "cancelled";
    task: string;
...
export interface WatcherRecord {
    ...
    createdAt: number;
    updatedAt: number;
    type: "command" | "build" | "test" | "download" | "log" | "file" | "remote" | "mcp";
...
export interface TimelineEvent {
    id: string;
    createdAt: number;
    type: "mode_switch" | "user_command" | "tool_call" | "file_edit" | "retry" | "rate_limit" | "validation" | "mcp_change" | "approval" | "goal" | "watcher" | "worker" | "system";
    sessionId?: string;
    taskId?: string;
    summary: string;
    detail?: string;
