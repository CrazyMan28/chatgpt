...
const STATIC_COPILOT_NOTE = "Static/manual entry. Availability depends on your GitHub Copilot plan and organization policy.";
export const STATIC_COPILOT_MODELS = [
    {
...
export function createManualCopilotModel(model) {
    return {
        id: model,
        label: model,
        capabilities: COPILOT_CAPABILITIES,
