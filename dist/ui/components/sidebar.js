...
export function Sidebar({ activeTools, autoModeLabel, autoModeLastAction, autoModeNextRunLabel, currentWorkflowLabel, executionModeLabel, height, lastToolSummary, phaseLabel, responseModeLabel, sessionLabel, step, taskLabel, tools, workflowProgressLabel, width }) {
    const appState = useAppRuntimeState();
    const innerWidth = Math.max(12, width - 4);
    const runningToolCount = activeTools.filter((tool) => tool.status === "running").length;
    const staticRows = activeTools.length > 0 ? 17 : 16;
    ...
    return (_jsx(Panel, { height: height, subtitle: `${tools.length} loaded`, title: "Inspector", width: width, children: _jsxs(Box, { flexDirection: "column", children: [_jsx(InspectorRow, { label: "State", value: phaseLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Session", value: sessionLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Mode", value: executionModeLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Style", value: responseModeLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Plan", value: workflowProgressLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Current", value: currentWorkflowLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Tasks", value: taskLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Auto", value: autoModeLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Next", value: autoModeNextRunLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Step", value: `${step || 0}`, width: innerWidth }), _jsx(InspectorRow, { label: "Provider", value: appState.providerLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Model", value: appState.model, width: innerWidth }), _jsx(InspectorRow, { label: "Login", value: appState.loginLabel, width: innerWidth }), _jsx(InspectorRow, { label: "Loaded", value: `${tools.length} total • ${coreToolCount} core • ${mcpToolCount} MCP`, width: innerWidth }), _jsx(InspectorRow, { label: "Active", value: `${runningToolCount} running`, width: innerWidth }), _jsx(InspectorRow, { label: "Recent", value: lastToolSummary, width: innerWidth }), _jsx(InspectorRow, { label: "Last auto", value: autoModeLastAction, width: innerWidth }), visibleActiveTools.length > 0 ? (visibleActiveTools.map((tool) => (_jsxs(Box, { children: [_jsx(Text, { color: tool.isError ? uiTheme.colors.warning : uiTheme.colors.text, children: truncate(tool.name, Math.max(8, innerWidth - 10)) }), _jsx(Spacer, {}), _jsx(Text, { color: uiTheme.colors.muted, children: tool.status })] }, tool.id)))) : (_jsx(Text, { color: uiTheme.colors.muted, children: "No active tools." })), hiddenActiveToolCount > 0 ? (_jsx(Text, { color: uiTheme.colors.muted, children: `+${hiddenActiveToolCount} more active` })) : null, visibleTools.length > 0 ? (visibleTools.map((tool) => (_jsxs(Box, { children: [_jsx(Text, { color: uiTheme.colors.text, children: truncate(tool.name, Math.max(8, innerWidth - 6)) }), _jsx(Spacer, {}), _jsx(Text, { color: uiTheme.colors.muted, children: tool.source })] }, tool.id)))) : (_jsx(Text, { color: uiTheme.colors.muted, children: "No tools registered." })), hiddenToolCount > 0 ? (_jsx(Text, { color: uiTheme.colors.muted, children: `+${hiddenToolCount} more` })) : null] }) }));
}
